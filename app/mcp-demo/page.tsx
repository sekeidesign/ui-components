...
export default function MCPDemo() {
	return (
		<div className="font-[family-name:var(--font-geist-sans)] w-full h-screen items-start justify-center flex flex-col gap-8 p-16 pt-8">
			<Header />
			<div className="relative shadow-skew h-full flex items-start justify-center rounded-xl border border-gray-200 w-full bg-white overflow-hidden">
				<DynamicIsland />
			</div>
		</div>
	);
...
const Header = () => {
	return (
		<div className="flex items-center justify-between w-full">
			<div>
				<h2 className="text-sm font-[450] text-gray-400">
					Friends of Figma Montréal
				</h2>
				<h1 className="text-xl font-[550]">MCP Demo</h1>
			</div>
			<div className="flex items-center gap-1.5 text-gray-500">
				...
				<span className="text-sm font-[500]">sekeidesign</span>
			</div>
		</div>
	);
};
